<?= form_open_multipart("admin/user/update/$data->login_id", [], $data->login_id === 0 ? ['otp_invoke'=>'y'] : []) ?>
...
<?php if($data->login_id): ?>
	...
	<hr>
	<?php control_div(['label'=>'', 'class'=>'form-control h-auto d-flex', 'value' => function() use ($data) {
			control_buttons([[
				'href' => '../delete/'.$data->login_id,
